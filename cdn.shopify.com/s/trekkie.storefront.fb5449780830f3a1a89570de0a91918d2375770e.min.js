! function() {
    var e = {
            ...
            8920: function(e, t, n) {
                ...
                function T() {
                    return d() === r.TrackingRegulations.CCPA && !!C(r.TrackingRegulationLimitations.CCPA) && _()
                }
            ...
            5461: function(e, t, n) {
                ...
                Object.defineProperty(t, "ConsentSignal", {
                    ...
                    const e = {
                        ...
                        shouldShowGDPRBanner: s.withBugsnag(g),
                        userDataCanBeSold: s.withBugsnag(_),
                    ...
                    return e
                }, t.thirdPartyMarketingAllowed = T, t.userCanBeTracked = p, t.userDataCanBeSold = _
            },
            2290: function(e, t, n) {
                "use strict";
                Object.defineProperty(t, "__esModule", {
            ...
            1930: function(e, t) {
                ...
                Object.defineProperty(t, "__esModule", {
                    value: !0
                }), t.extractSchemaIdFromEventName = t.buyWithPrimePresenceSchemaId = t.trekkieAssetContextSchemaId = t.customStorefrontAnalyticsSchemaId = t.storefrontAnalyticsSchemaId = t.appNameToEcommerceEventSchemaId = t.appNameToPageViewSchemaId = void 0, t.appNameToPageViewSchemaId = {
                ...
                }, t.storefrontAnalyticsSchemaId = "storefront_customer_tracking/4.7", t.customStorefrontAnalyticsSchemaId = "custom_storefront_customer_tracking/1.1", t.trekkieAssetContextSchemaId = "trekkie_asset_context/1.1", t.buyWithPrimePresenceSchemaId = "storefront_buy_with_prime_presence/1.0", t.extractSchemaIdFromEventName = function(e) {
                    var t = "monorail://",
                        n = e.toLowerCase();
                    ...
                    l = function(e) {
                        ...
                        return r(t, e), t.prototype.isEssential = function() {
                            ...
                            for (var t = this.options, n = 0, o = this.getFacebookPixelIds(t); n < o.length; n++) {
                                var r = o[n];
                                c.userDataCannotBeSold() && this.setLimitedDataUseMode(), window.fbq("init", r), "" !== t.agent && window.fbq("set", "agent", t.agent, r)
                            }
                            e()
                        ...
                        return r(t, e), t.prototype.isEssential = function() {
                            ...
                            var t = "view_item",
                                ...
                                o = {
                                    ...
                                    items: [{
                                        id: this.computeProductIdForEvent(n),
                                        name: n.name,
                                        brand: n.brand,
                                        category: n.category,
                                        coupon: n.coupon,
                            ...
                            var t = this,
                                ...
                                r = {
                                    ...
                                    items: o.products.map((function(e) {
                                        return {
                                            id: t.computeProductIdForEvent(e),
                                            name: e.name,
                                            brand: e.brand,
                                            category: e.category,
                                            coupon: e.coupon,
                            ...
                            var t = this,
                                ...
                                r = {
                                    send_to: this.gtagEventLabelFor(n),
                                    ecomm_prodid: this.generateProductIds(o.products),
                            ...
                            for (var t = [], n = 0, o = e; n < o.length; n++) {
                                var r = o[n],
                                    i = "shopify_" + this.targetCountry() + "_" + r.productId + "_" + r.variantId;
                                t.push(i)
                            }
                            return t
                        }, t.prototype.computeProductIdForEvent = function(e) {
                            return u.default.isEnabled(u.GTAG_USE_ECOMM_PROD_ID_AS_PROD_ID_BETA_FLAG) ? "shopify_" + this.targetCountry() + "_" + e.productId + "_" + e.variantId : e.productId || e.variantId
            ...
            3653: function(e, t, n) {
                ...
                var h = function(e) {
                    function n(t, o) {
                        ...
                        return r.pageID = l.buildToken(), r
                    }
                    return r(n, e), n.prototype.isEssential = function() {
                        ...
                        return g.IntegrationTypes.ECOMMERCE
                        ...
                        var t = e.eventName,
                            n = e.eventObject,
                            o = e.eventPayload,
                            r = this.isCustomStorefront(t),
                            i = {
                                schemaId: r ? d.customStorefrontAnalyticsSchemaId : d.storefrontAnalyticsSchemaId,
                                payload: this.eventWithMetadata(t, r ? this.payloadWithCustomStorefrontMetadata(o) : o, n.s2sMetadata)
                            };
                        p.produce([i])
                        ...
                        var n = this.options,
                            o = [t.PAGE_RENDERED_EVENT_NAME, t.PAYMENT_INFO_SUBMITTED_EVENT_NAME, t.CHECKOUT_CONTACT_INFO_SUBMITTED_EVENT_NAME, t.CHECKOUT_ADDRESS_INFO_SUBMITTED_EVENT_NAME, t.CHECKOUT_SHIPPING_INFO_SUBMITTED_EVENT_NAME, t.CHECKOUT_STARTED_EVENT_NAME, t.CHECKOUT_COMPLETED_EVENT_NAME],
            ...
            2724: function(e, t, n) {
                ...
                var u = function(e) {
                    ...
                    return r(n, e), n.prototype.isEssential = function() {
                        ...
                        this.timestampManager = new p, this.campaignManager = new d, e()
                    ...
                    c = function(e) {
                        ...
                        return r(t, e), t.prototype.isEssential = function() {
                            ...
                            var t = e.properties,
                                ...
                                o = this.options;
                            window.ttq.instance(o.pixelId).track("ViewContent", n, {
                                event_id: e.eventId
                            }), this.addMonorailBatchEvent({
                                eventName: i.ANALYTICS_VIEWED_PRODUCT,
                                eventProperties: JSON.stringify(n)
                            ...
                            var t = e.properties,
                                ...
                                o = this.options;
                            window.ttq.instance(o.pixelId).track("AddToCart", n, {
                                event_id: e.eventId
                            }), this.addMonorailBatchEvent({
                                eventName: i.ANALYTICS_ADDED_PRODUCT,
                                eventProperties: JSON.stringify(n)
                            ...
                            var t = e.properties,
                                ...
                                o = this.options;
                            window.ttq.instance(o.pixelId).track("AddBilling", n, {
                                event_id: e.eventId
                            }), this.addMonorailBatchEvent({
                                eventName: i.ANALYTICS_ADDED_PAYMENT,
                                eventProperties: JSON.stringify(n)
                            ...
                            var t = e.properties,
                                ...
                                o = this.options;
                            window.ttq.instance(o.pixelId).track("StartCheckout", n, {
                                event_id: e.eventId
                            }), this.addMonorailBatchEvent({
                                eventName: i.ANALYTICS_STARTED_ORDER,
                                eventProperties: JSON.stringify(n)
                            ...
                            var t = e.properties,
                                ...
                                o = this.options;
                            window.ttq.instance(o.pixelId).track("Purchase", n, {
                                event_id: e.eventId
                            }), this.addMonorailBatchEvent({
                                eventName: i.ANALYTICS_COMPLETED_ORDER,
                                eventProperties: JSON.stringify(n)
                ...
                var a = n(372),
                    ...
                    l = function(e) {
                        ...
                        return r(t, e), t.prototype.isEssential = function() {
                            ...
                            var t = s.extractSchemaIdFromEventName(e.event);
                            this.emit("track", e, t)
            ...
            9115: function(e, t) {
                ...
                Object.defineProperty(t, "__esModule", {
                    value: !0
                }), t.GTAG_USE_ECOMM_PROD_ID_AS_PROD_ID_BETA_FLAG = t.DEFAULT_TO_ORDER_ID_BETA_FLAG = void 0, t.DEFAULT_TO_ORDER_ID_BETA_FLAG = "defaultToOrderId", t.GTAG_USE_ECOMM_PROD_ID_AS_PROD_ID_BETA_FLAG = "gtagUseEcommProdIdAsProdId";
                var n = function() {
                    function e() {
                        this.betaFlagsProps = []
                    }
                    ...
                    if (void 0 === o)
                        if (function() {
                            ...
                            for (var e = "", n = 0, r = p.hostname().split(".").reverse(); n < r.length; n++) {
                                ...
                                if (y(g, a, 0, e), s = g, c = a, u = void 0, (u = t.cookieImpl.read(s)) && u === c) return y(g, a, -1, e), void(o = e)
                            }
                            o = ""
                        }
                    var s, c, u
                ...
                t.parseDocumentCookie = v, t.cookieImpl = {
                    ...
                    write: function(e, n, o) {
                        if (void 0 === o && (o = {}), t.cookieImpl.enabled() && t.cookieImpl.allowed(e)) {
                            ...
                            o.maxage && (o.maxage < 0 ? o.expires = _ : o.expires = new Date((new Date).getTime() + o.maxage)), o.path && (r += "; path=" + o.path), o.domain && (r += "; domain=" + o.domain), (o.maxage < 0 || o.expires && c.isLegacyGdprNotEnforced()) && (r += "; expires=" + o.expires.toUTCString()), o.samesite ? r += "; SameSite=" + o.samesite : r += "; SameSite=Lax", o.secure && (r += "; secure"), i.virtualDocument().setCookie(r)
                        }
                    },
                    enabled: function(e) {
            ...
            7662: function(e, t, n) {
                ...
                t.TrackingRegulationLimitations = o.TrackingRegulationLimitations, t.TrackingEvents = o.TrackingEvents, t.isLegacyGdprEnforced = function() {
                    ...
                    o.resetCookieCache()
                }, t.analyticsProcessingAllowed = d, t.firstPartyMarketingAllowed = l, t.preferencesProcessingAllowed = f, t.thirdPartyMarketingAllowed = g
            },
            6851: function(e, t, n) {
                "use strict";
            ...
            2971: function(e, t, n) {
                ...
                t.metricsSchemaId = "trekkie_metrics/2.0", t.errorsSchemaId = "trekkie_errors/2.0", t.setGlobalSerializedAppConfig = function(e) {
                    ...
                    if (this.shouldSendToBugsnag()) {
                        var n = "fb5449780830f3a1a89570de0a91918d2375770e",
                            o = null,
                            r = null,
                            i = null;
                        if (e.appConfig) try {
            ...
            5316: function(e, t, n) {
                ...
                a.push(["S2S", g.S2S]);
                try {
                    var _ = window.trekkie.config;
                    if (_) {
                        r.setGlobalSerializedAppConfig(JSON.stringify(_));
                        var v = window.trekkie,
                            h = window.trekkie = new o.Tricorder(a, _, (function() {
            ...
            9426: function(e, t, n) {
                    ...
                    m = function() {
                        ...
                        return e.prototype.configureMonorailRegion = function(e) {
                            ...
                            s.addBatchEvent({
                                ...
                                payload: {
                                    build_id: "fb5449780830f3a1a89570de0a91918d2375770e",
                                ...
                                try {
                                    if ("https://order.buywithprime.amazon.com/" === e.origin) {
                                        var p = null === (n = null === (t = window.ShopifyAnalytics) || void 0 === t ? void 0 : t.meta) || void 0 === n ? void 0 : n.product,
                                            l = (null === (i = null == p ? void 0 : p.variants) || void 0 === i ? void 0 : i.length) > 0 ? null === (a = null == p ? void 0 : p.variants[0]) || void 0 === a ? void 0 : a.id : void 0,
                            ...
                            return {
                                s2sMetadata: i,
                                eventId: "string" == typeof r && r.length > 0 ? r : p.buildToken()
                            }
                            ...
                            if (u.isMerchantOnGranularConsentBeta()) {
                                u.haveConsentForIntegration(this.trekkie) || (E.Trekkie = [!1, this.trekkie, []]);
                                for (var i = 0, a = e; i < a.length; i++) {
                                    var s = a[i];
                                    try {
                                        if ((v = t[_ = s[0]]) && "object" == typeof v) {
                                            var p = new(0, s[1])(v, r);
                                            this.integrations.push(p);
                                            var d = p.type() === l.IntegrationTypes.ECOMMERCE;
                                            u.haveConsentForIntegration(p) ? d ? p.initialize(r) : r() : (E[_] = [d, p, []], r())
                                        } else r()
                                    } catch (e) {
                                        r(), c.reportError("loadIntegration", e)
                                    }
                                }
                                this.setupGranularConsentEventListener(E)
                            } else
                                for (var f = 0, g = e; f < g.length; f++) {
                                    s = g[f];
                                    try {
                                        var _, v;
                                        (v = t[_ = s[0]]) && "object" == typeof v ? (p = new(0, s[1])(v, r), this.integrations.push(p)) : r()
                                    } catch (e) {
                                        r(), c.reportError("loadIntegration", e)
                                    }
                                }
                            ...
                            return e.isEssential() || u.isLegacyGdprNotEnforced()
                            ...
                            if (u.isMerchantOnGranularConsentBeta())
                                for (var i = 0, a = this.integrations; i < a.length; i++) {
                                    var s = a[i];
                                    try {
                                        if (u.haveConsentForIntegration(s)) s.page(r);
                                        else {
                                            var p = s.name(),
                                                d = E[p][2],
                                                l = ["page", r];
                                    ...
                                    for (var f = function(e) {
                                            try {
                                                if (g.canEmitEvent(e)) e.page(r);
                                                else {
                                                    var t = function() {
                                                        e.page(r), document.removeEventListener(u.TrackingEvents.TRACKING_ACCEPTED, t)
                                                    };
                                                    document.addEventListener(u.TrackingEvents.TRACKING_ACCEPTED, t)
                                                }
                                            } catch (e) {
                                                c.reportError("page", e)
                                            }
                                        }, g = this, _ = 0, v = this.integrations; _ < v.length; _++) f(s = v[_]);
                            return this.flushMonorailEventsIfLoaded(), o.eventId
                        }, e.prototype.track = function(e, t, n) {
                            void 0 === e && (e = ""), void 0 === t && (t = {});
                            var o = this.getS2SEventId(e, t),
                                r = this.getS2SEventId("Page View");
                            e instanceof Object && (t = e, e = "");
                            var i = {
                                event: e,
                            ...
                            if (u.isMerchantOnGranularConsentBeta())
                                for (var a = 0, s = this.integrations; a < s.length; a++) {
                                    var p = s[a];
                                    try {
                                        if (u.haveConsentForIntegration(p)) p.track(i);
                                        else {
                                            var d = p.name(),
                                                l = E[d][2],
                                                f = ["track", i];
                                    ...
                                    for (var g = function(e) {
                                            try {
                                                if (_.canEmitEvent(e)) e.track(i);
                                                else {
                                                    var t = function() {
                                                        e.track(i), document.removeEventListener(u.TrackingEvents.TRACKING_ACCEPTED, t)
                                                    };
                                                    document.addEventListener(u.TrackingEvents.TRACKING_ACCEPTED, t)
                                                }
                                            } catch (e) {
                                        ...
                                        }, _ = this, v = 0, h = this.integrations; v < h.length; v++) g(p = h[v]);
                            return this.flushMonorailEventsIfLoaded(), o.eventId
                            ...
                            Object.keys(e).length > 0 && (this.defList = this.consentCollectedListener.bind(this), document.addEventListener(u.TrackingEvents.CONSENT_COLLECTED, this.defList))
                            ...
                            for (var n = [], o = 0; o < Object.keys(E).length; o++) {
                                var r = Object.keys(E)[o],
                                    i = E[r],
                                    a = i[0],
                                    s = i[1],
                                    c = i[2];
                                if (u.haveConsentForIntegrationFromEvent(s, t)) {
                ...
                t.Tricorder = m, t.resetDeferredIntegrations = function() {
                    E = {}
