(() => {
    var e = {
            ...
            700: function(e, t, r) {
                ...
                ! function(n, o) {
                    ...
                    var a = "function",
                        ...
                        H = function(e, t) {
                            ...
                            return this.getBrowser = function() {
                                var e, t = {};
                                return t.name = o, t.version = o, _.call(t, i, d.browser), t.major = typeof(e = t.version) === l ? e.replace(/[^\d\.]/g, "").split(".")[0] : o, r && r.brave && typeof r.brave.isBrave == a && (t.name = "Brave"), t
                            }, this.getCPU = function() {
                                var e = {};
                                return e.architecture = o, _.call(e, i, d.cpu), e
                            }, this.getDevice = function() {
                                var e = {};
                                return e.vendor = o, e.model = o, e.type = o, _.call(e, i, d.device), !e.type && u && u.mobile && (e.type = g), "Macintosh" == e.model && r && typeof r.standalone !== s && r.maxTouchPoints && r.maxTouchPoints > 2 && (e.model = "iPad", e.type = h), e
                            }, this.getEngine = function() {
                                var e = {};
                                return e.name = o, e.version = o, _.call(e, i, d.engine), e
                            }, this.getOS = function() {
                                var e = {};
                                return e.name = o, e.version = o, _.call(e, i, d.os), !e.name && u && "Unknown" != u.platform && (e.name = u.platform.replace(/chrome os/i, U).replace(/macos/i, j)), e
                    ...
                    H.VERSION = "1.0.34", H.BROWSER = F([d, m, "major"]), H.CPU = F([p]), H.DEVICE = F([u, f, b, w, g, v, h, y, x]), H.ENGINE = H.OS = F([d, m]), typeof t !== s ? (e.exports && (t = e.exports = H), t.UAParser = H) : r.amdO ? (i = function() {
                        return H
    ...
    r.amdO = {}, (() => {
        ...
        class p extends Error {
            constructor(...e) {
                super(...e), Error.captureStackTrace && Error.captureStackTrace(this, p)
            }
        }
                        ...
                        try {
                            d = function(e, t) {
                                ...
                                const i = {
                                    ...
                                    columnNumber: "1",
                                    method: t.context,
                                    file: "https://cdn.shopify.com/s6d6339c0w77483ddapdc20cb53m2575a67fm.js"
                                };
                                if (e.stackTrace || e.stack || e.description) {
                                    r = e.stack.split("\n")[0];
                                    const t = e.stack.match(/([0-9]+):([0-9]+)/);
                                    if (t && t.length > 2 && (i.lineNumber = t[1], i.columnNumber = t[2], parseInt(i.lineNumber, 10) > 1e5)) throw new w
                                }
                                return {
                            ...
                            events: [{
                                ...
                                metaData: {
                                    app: {
                                        ...
                                        env: l,
                                        hashVersion: "6d6339c0w77483ddapdc20cb53m2575a67f"
                                    },
                                    device: {
        ...
        function O(e, t) {
            ...
            do {
                Object.getOwnPropertyNames(r).filter((e => e in t && !1 !== t[e])).forEach((e => {
                    try {
                        let i;
                        "object" == typeof t[e] ? (i = r[e], O(i, t[e])) : i = !0 === t[e] ? void 0 : t[e], v(r, e, {
                            value: i,
                            configurable: !1,
                            enumerable: !1,
                            writable: !1
        ...
        function I(e) {
            return C(window, "localStorage", e.localStorage)
        }

        function L(e) {
            return C(window, "sessionStorage", e.sessionStorage)
        }
        ...
        function P(e, t, r, i, n) {
            ...
            h(e, {
                ...
                pixelType: c,
                runtimeContext: l,
                context: `createSandbox/${t}`,
                userAgent: (null == i || null === (o = i.navigator) || void 0 === o ? void 0 : o.userAgent) || (null === (a = self) || void 0 === a || null === (s = a.navigator) || void 0 === s ? void 0 : s.userAgent)
            }), n && n.monorail.register({
                status: "failed",
            ...
            try {
                ...
                t = function(e, {
                    ...
                    return c.addEventListener("message", m), {
                        ...
                        terminate() {
                            f(2, void 0), g(), c.terminate && c.terminate()
                        }
                    };
                    ...
                    callable: ["pixelRuntimeAPI", "sandboxInternalAPI"]
                }), e = new Set, t.expose({
                    initialize: async function(r, i, n) {
                        try {
                            const [a, s] = await Promise.all([t.call.pixelRuntimeAPI(), t.call.sandboxInternalAPI()]);
                            try {
                                const t = b();
                                if (t && (a.browser.sendBeacon = d), E(t), !t) {
                                    const e = await s.cookieRestrictedDomains();
                                    await
                                    function(e, t, r) {
                                        const i = [A(e.cookie.get, e.cookie.set, r).initialize(), T(t.self.origin.get).initialize(), B(t.document.referrer.get).initialize(), I(e).initialize(), L(e).initialize()];
                                        return Promise.allSettled ? Promise.allSettled(i) : Promise.all(i)
                                    }(a.browser, s, e), self.document.title = r
                                }
                                Object.defineProperty(self, "webPixelsManager", {
                                    value: {
                                        createShopifyExtend: () => ({
                                            extend: async (t, r) => {
                                                if ("WebPixel::Render" !== t) throw new M;
                                                const o = () => {
                                                    try {
                                                        r.call(a, a), s.monorail.register({
                                                            status: "registered"
                                                        })
                                                    } catch (e) {
                                                        throw P(e, "extend", i, n, s), e
                                                    }
                                                };
                                                await s.userCanBeTracked() ? o() : e.add(o)
                                            }
                                        })
                                    },
                                    enumerable: !0,
                                ...
                                try {
                                    ...
                                    P(o, "initWebPixel", i, n, s)
                                }
                                return !0
                            } catch (o) {
                                return P(o, "initialize/retrievedApi", i, n, s), !1
                            }
                        } catch (o) {
                            return P(o, "initialize", i, n), !1
                        }
                    },
                    initWebPixelsAwaitingConsent: function() {
                        e.forEach((t => {
                            e.delete(t), t()
                        }))
                    }
        ...
        self.webPixelsManagerSandbox = D
    })()
})();